    ...
    module PhotoslibraryV1
      ...
      class Album
        ...
        class Representation < Google::Apis::Core::JsonRepresentation
          ...
          property :cover_photo_media_item_id, as: 'coverPhotoMediaItemId'
          property :id, as: 'id'
          property :is_writeable, as: 'isWriteable'
          property :media_items_count, :numeric_string => true, as: 'mediaItemsCount'
      ...
      class BatchAddMediaItemsToAlbumRequest
        # @private
        class Representation < Google::Apis::Core::JsonRepresentation
          collection :media_item_ids, as: 'mediaItemIds'
        end
      end
      ...
      class BatchGetMediaItemsResponse
        # @private
        class Representation < Google::Apis::Core::JsonRepresentation
          collection :media_item_results, as: 'mediaItemResults', class: Google::Apis::PhotoslibraryV1::MediaItemResult, decorator: Google::Apis::PhotoslibraryV1::MediaItemResult::Representation
      ...
      class FeatureFilter
        # @private
        class Representation < Google::Apis::Core::JsonRepresentation
          collection :included_features, as: 'includedFeatures'
        end
      end
      ...
      class Filters
        ...
        class Representation < Google::Apis::Core::JsonRepresentation
          ...
          property :exclude_non_app_created_data, as: 'excludeNonAppCreatedData'
          property :feature_filter, as: 'featureFilter', class: Google::Apis::PhotoslibraryV1::FeatureFilter, decorator: Google::Apis::PhotoslibraryV1::FeatureFilter::Representation
      ...
      class ShareInfo
        # @private
        class Representation < Google::Apis::Core::JsonRepresentation
          property :is_joined, as: 'isJoined'
          property :is_owned, as: 'isOwned'
          property :share_token, as: 'shareToken'
